...
export type ManagedLogFilePrefix = 'pengcodex' | 'deepseek-gui' | 'kun'
...
const MANAGED_LOG_FILE_PREFIXES: ManagedLogFilePrefix[] = ['pengcodex', 'deepseek-gui', 'kun']
...
async function writeLogLine(level: LogLevel, category: string, message: string): Promise<void> {
  ...
  await appendManagedLogLine('pengcodex', line)
}
