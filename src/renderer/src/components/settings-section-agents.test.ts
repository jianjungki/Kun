...
const labels: Record<string, string> = {
  ...
  mcp: 'MCP',
  webSearchEnabled: 'Web access',
  webSearchEnabledDesc: 'Web access description',
  webSearchProvider: 'Web search provider',
  webSearchProviderDesc: 'Web search provider description',
  webSearchProviderFetch: 'Built-in fetch only',
  webSearchProviderBrave: 'Brave Search API',
  webSearchProviderDuckDuckGo: 'DuckDuckGo Instant Answer',
  webSearchProviderSearxng: 'SearXNG instance',
  webSearchModes: 'Enabled web tools',
  webSearchModesDesc: 'Enabled web tools description',
  webFetchEnabled: 'Fetch pages',
  webCloudSearchEnabled: 'Cloud search',
  webFetchProvider: 'Page fetch provider',
  webFetchProviderDesc: 'Page fetch provider description',
  webFetchProviderDirect: 'Direct fetch',
  webFetchProviderJina: 'Jina Reader',
  webFetchProviderFirecrawl: 'Firecrawl',
  webFetchProviderBrowserMcp: 'Browser / MCP',
  webFetchJinaHint: 'Jina Reader hint',
  webFetchFirecrawlHint: 'Firecrawl hint',
  webFetchBrowserMcpHint: 'Browser MCP hint',
  webFetchReaderBaseUrl: 'Reader endpoint',
  webFetchReaderBaseUrlDesc: 'Reader endpoint description',
  webFetchApiKey: 'Reader API key',
  webFetchApiKeyDesc: 'Reader API key description',
  webFetchApiKeyPlaceholder: 'Reader API key placeholder',
  webSearchApiKey: 'Search API key',
  webSearchApiKeyDesc: 'Search API key description',
  webSearchApiKeyPlaceholder: 'Brave Search API key',
  webSearchAdvanced: 'Web access advanced settings',
  webSearchAdvancedDesc: 'Web access advanced settings description',
  webSearchBaseUrl: 'Search endpoint',
  webSearchBaseUrlDesc: 'Search endpoint description',
  webSearchDuckDuckGoHint: 'DuckDuckGo hint',
  webSearchSearxngHint: 'SearXNG hint',
  webSearchDomains: 'Fetch domain policy',
  webSearchDomainsDesc: 'Fetch domain policy description',
  webSearchAllowDomains: 'Allowed domains, one per line',
  webSearchDenyDomains: 'Denied domains, one per line',
